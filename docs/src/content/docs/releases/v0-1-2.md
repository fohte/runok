...
([#152](https://github.com/fohte/runok/pull/152))

## Bug Fixes

### Command substitutions in quoted strings now evaluated
...
([#151](https://github.com/fohte/runok/pull/151))

### Stack overflow with command substitutions fixed
...
([#149](https://github.com/fohte/runok/pull/149))

### `--` treated as positional literal
...
([#153](https://github.com/fohte/runok/pull/153))

### Flag alternation no longer consumes placeholders
...
([#154](https://github.com/fohte/runok/pull/154))
