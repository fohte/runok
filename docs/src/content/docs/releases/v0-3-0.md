...
Released on 2026-05-16. [Full changelog](https://github.com/fohte/runok/compare/v0.2.4...v0.3.0)
...
See [Filesystem functions](/rule-evaluation/when-clause/#functions) for the full behaviour reference.
