...
Released on 2026-04-03. [Full changelog](https://github.com/fohte/runok/compare/v0.2.0...v0.2.1)
...
### `runok test` no longer evaluates inline tests from remote presets ([#227](https://github.com/fohte/runok/pull/227))
