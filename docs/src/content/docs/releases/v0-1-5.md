...
### `=`-joined flags now match alternation patterns correctly
...
([#196](https://github.com/fohte/runok/pull/196))

### Flag negation no longer consumed as preceding flag's value
...
([#191](https://github.com/fohte/runok/pull/191))
