...
### Order-independent matching for literal tokens
...
([#177](https://github.com/fohte/runok/pull/177))

### Hook conflict detection in `runok init`
...
([#186](https://github.com/fohte/runok/pull/186))

## Bug Fixes

### Compound command substitution evaluation fix
...
([#178](https://github.com/fohte/runok/pull/178))

### `=`-joined tokens now match `FlagWithValue` and negation patterns
...
([#180](https://github.com/fohte/runok/pull/180))
...
([#175](https://github.com/fohte/runok/pull/175))

### Flag-only negation with empty commands
...
([#179](https://github.com/fohte/runok/pull/179))
