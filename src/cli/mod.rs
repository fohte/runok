...
pub struct ExecArgs {
    ...
    /// Internal marker for commands generated by a hook wrapper.
    #[arg(long = "hook-origin", hide = true)]
...
mod tests {
    ...
    #[case::exec_simple(
        ...
        Commands::Exec(ExecArgs { command: vec!["git".into(), "status".into()], sandbox: vec![], ask: false, hook_origin: None, verbose: false }),
    )]
    #[case::exec_with_sandbox(
        &["runok", "exec", "--sandbox", "strict", "--", "ls"],
        Commands::Exec(ExecArgs { command: vec!["ls".into()], sandbox: vec!["strict".into()], ask: false, hook_origin: None, verbose: false }),
    )]
    #[case::exec_with_multiple_sandboxes(
        &["runok", "exec", "--sandbox", "strict", "--sandbox", "readonly", "--", "ls"],
        Commands::Exec(ExecArgs { command: vec!["ls".into()], sandbox: vec!["strict".into(), "readonly".into()], ask: false, hook_origin: None, verbose: false }),
    )]
    #[case::exec_with_ask(
        &["runok", "exec", "--ask", "--", "git", "push"],
        Commands::Exec(ExecArgs { command: vec!["git".into(), "push".into()], sandbox: vec![], ask: true, hook_origin: None, verbose: false }),
    )]
    #[case::exec_with_hook_origin(
        &["runok", "exec", "--hook-origin", "token", "--", "ls"],
        Commands::Exec(ExecArgs { command: vec!["ls".into()], sandbox: vec![], ask: false, hook_origin: Some("token".into()), verbose: false }),
    )]
    #[case::exec_with_ask_and_hook_origin(
        &["runok", "exec", "--ask", "--hook-origin", "token", "--", "git", "push"],
        Commands::Exec(ExecArgs { command: vec!["git".into(), "push".into()], sandbox: vec![], ask: true, hook_origin: Some("token".into()), verbose: false }),
    )]
    #[case::exec_with_verbose(
        &["runok", "exec", "--verbose", "--", "git", "status"],
        Commands::Exec(ExecArgs { command: vec!["git".into(), "status".into()], sandbox: vec![], ask: false, hook_origin: None, verbose: true }),
    )]
