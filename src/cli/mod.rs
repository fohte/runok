...
pub struct ExecArgs {
    ...
    /// Internal: marks this invocation as generated by the Claude Code hook
    /// wrapper, so that `defaults.action: pass` executes under the resolved
    /// sandbox instead of being denied.
    #[arg(long = "__hook-origin", hide = true)]
    pub hook_origin: bool,
...
mod tests {
    ...
    #[case::exec_simple(
        ...
        Commands::Exec(ExecArgs { command: vec!["git".into(), "status".into()], sandbox: None, verbose: false, hook_origin: false }),
    )]
    #[case::exec_with_sandbox(
        &["runok", "exec", "--sandbox", "strict", "--", "ls"],
        Commands::Exec(ExecArgs { command: vec!["ls".into()], sandbox: Some("strict".into()), verbose: false, hook_origin: false }),
    )]
    #[case::exec_with_verbose(
        &["runok", "exec", "--verbose", "--", "git", "status"],
        Commands::Exec(ExecArgs { command: vec!["git".into(), "status".into()], sandbox: None, verbose: true, hook_origin: false }),
    )]
    #[case::exec_with_hook_origin(
        &["runok", "exec", "--sandbox", "strict", "--__hook-origin", "--", "ls"],
        Commands::Exec(ExecArgs { command: vec!["ls".into()], sandbox: Some("strict".into()), verbose: false, hook_origin: true }),
    )]
