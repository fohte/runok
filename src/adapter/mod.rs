...
mod tests {
    ...
    #[case::ask("terraform apply", ask_rule("terraform apply"), Action::Ask(crate::rules::rule_engine::AskResponse { message: Some("please confirm".to_string()), fix_suggestion: None }))]
