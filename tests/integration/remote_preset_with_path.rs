...
#[case::sed_inplace_excluded("sed -i s/foo/bar/ file.txt", assert_pass as ActionAssertion)]
#[case::find_delete_excluded("find -delete .", assert_pass as ActionAssertion)]
#[case::rm_not_allowed("rm -rf /", assert_pass as ActionAssertion)]
#[case::curl_not_allowed("curl https://example.com", assert_pass as ActionAssertion)]
...
#[case::git_add_not_allowed("git add .", assert_pass as ActionAssertion)]
#[case::git_commit_not_allowed("git commit -m 'test'", assert_pass as ActionAssertion)]
#[case::git_push_not_allowed("git push origin main", assert_pass as ActionAssertion)]
...
#[case::rm_not_in_any("rm -rf /", assert_pass as ActionAssertion)]
...
#[case::rm_not_via_base("rm -rf /", assert_pass as ActionAssertion)]
...
#[case::bash_c_rm_not_allowed(r#"bash -c "rm -rf /""#, assert_pass as ActionAssertion)]
