...
#[case::with_wrong_value("curl -X POST https://example.com", assert_pass as ActionAssertion)]
...
#[case::equals_joined_wrong_value("curl -X=POST https://example.com", assert_pass as ActionAssertion)]
...
#[case::safe_file("cat /tmp/safe.txt", assert_pass as ActionAssertion)]
#[case::readme("cat README.md", assert_pass as ActionAssertion)]
...
#[case::safe_allowed("cat /tmp/notes.txt", assert_pass as ActionAssertion)]
...
#[case::safe_no_flag("rm temp.txt", assert_pass as ActionAssertion)]
#[case::safe_with_flag("rm -f temp.txt", assert_pass as ActionAssertion)]
...
#[case::get("curl -X GET https://api.com", assert_pass as ActionAssertion)]
...
#[case::get_not_matched("curl -X GET https://api.com", assert_pass as ActionAssertion)]
...
#[case::cat_safe_default("cat README.md", assert_pass as ActionAssertion)]
#[case::vim_sensitive_default("vim .env", assert_pass as ActionAssertion)]
...
#[case::force_push_develop_default("git push --force develop", assert_pass as ActionAssertion)]
#[case::normal_push_main_default("git push main", assert_pass as ActionAssertion)]
